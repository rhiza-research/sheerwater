...
if __name__ == "__main__":
    ...
    for softening in softenings:
        ...
        for satellite_threshold in satellite_thresholds:
            ...
            plt.suptitle(
                f"station: {station_threshold}mm | satellite: {satellite_threshold}mm | agg: {agg_days}d | softening: {softening}d")
            plt.savefig(
                f"results_{agg_days}/results_soft_{softening}/ber_{station_threshold}_{satellite_threshold}.png")
            plt.close()
