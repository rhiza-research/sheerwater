...
from sheerwater.utils import start_remote, start_ray_remote
...
combos = itertools.product(forecasts, truth,  variables, grids, agg_days, space_groupings, time_groupings, metrics)
...
def run_grouped(combo):
    ...
    try:
        return metric(start_time, end_time, variable, agg_days=agg_days, forecast=forecast,
                      ...
                      cache_mode='overwrite', filepath_only=True, recompute=recompute, retry_null_cache=True, local_ray=True)
