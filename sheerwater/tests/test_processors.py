...
@processor()
def test_processor(ds, **kwargs):
    return ecmwf_ifs_er("2021-01-01", "2021-01-05")

def test_basic_processor(remote_dask_cluster):
    ds = ecmwf_ifs_er_debiased("2021-01-01", "2021-01-05", agg_days=1, processors=['test_processor'])
