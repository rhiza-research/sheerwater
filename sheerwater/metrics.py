...
@cache(cache_args=['start_time', 'end_time', 'variable', 'agg_days',
                   ...
                   'event', 'event_kwargs', 'fcst_event_kwargs', 'obs_event_kwargs',
...
def metric(start_time, end_time, variable, forecast, truth,
           ...
           event=None, event_kwargs=None, fcst_event_kwargs=None, obs_event_kwargs=None,
           agg_days=1,
    ...
    metric_obj = metric_factory(metric_name, metric_kwargs=metric_kwargs,
                                ...
                                fcst_event_kwargs=fcst_event_kwargs, obs_event_kwargs=obs_event_kwargs,
