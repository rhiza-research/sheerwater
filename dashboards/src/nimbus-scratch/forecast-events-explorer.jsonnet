  ...
  "templating": {
    "list": [
      ...
      },
      {
        ...
        "type": "custom",
        "description": "Lead for the precipitation timeseries only (same mapping as Forecast Explorer: 1=1d, 2=7d, 3=14d, 4=21d). Map and Events always use lead 7."
      },
      {
        "allowCustomValue": false,
        "current": {
      ...
      },
      {
        ...
        "query": "Observations : True, Forecast : False",
        "type": "custom",
        "description": "Which events to score on the map and Events panel. Observations = observed events (forecast_filter=False). Forecast = forecast-triggered events (obs_filter=False). Early season always uses Observations (short-lead models lack 120d leads)."
      },
      {
        "allowCustomValue": false,
        "current": {
      ...
      },
      {
        ...
        "definition": "SELECT CASE\n    WHEN '${event_type}' LIKE 'early_season%' THEN 'False'\n    WHEN '${obs_filter}' = 'True' THEN 'False'\n    WHEN '${obs_filter}' = 'False' THEN 'True'\nEND",
        "description": "Derived forecast_filter for table hashes (forced False for early season).",
        "hide": 2,
        "name": "fcst_filter",
        "options": [],
        "query": "SELECT CASE\n    WHEN '${event_type}' LIKE 'early_season%' THEN 'False'\n    WHEN '${obs_filter}' = 'True' THEN 'False'\n    WHEN '${obs_filter}' = 'False' THEN 'True'\nEND",
      ...
      {
        "current": {},
        "definition": "SELECT CASE\n    WHEN '${event_type}' LIKE 'early_season%' THEN 'True'\n    ELSE '${obs_filter}'\nEND",
        "description": "Derived obs_filter for table hashes (forced True for early season).",
        "hide": 2,
        "includeAll": false,
        "name": "obs_filter_eff",
        "options": [],
      ...
      {
        "current": {},
        "definition": "SELECT md5(\n    'forecast_metric_points/1_2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_western_africa_2016-01-01_None_${eval_truth}_precip'\n)",
        "hide": 2,
      ...
      {
        "current": {},
        "definition": "SELECT md5(\n    'forecast_metric_points/1_2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_eastern_africa_2016-01-01_None_${eval_truth}_precip'\n)",
        "hide": 2,
      ...
      {
        "current": {},
        "definition": "SELECT md5('event_list/2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_western_africa_2016-01-01_None_${eval_truth}_precip')",
        "hide": 2,
        "name": "event_list_table_west",
        "options": [],
        "query": "SELECT md5('event_list/2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_western_africa_2016-01-01_None_${eval_truth}_precip')",
        "refresh": 2,
        "regex": "",
        "type": "query",
        "includeAll": false,
      ...
      {
        "current": {},
        "definition": "SELECT md5('event_list/2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_eastern_africa_2016-01-01_None_${eval_truth}_precip')",
        "hide": 2,
        "name": "event_list_table_east",
        "options": [],
        "query": "SELECT md5('event_list/2024-12-31_${eval_forecast}_global1_5_7_forecast_filter-${fcst_filter}_obs_filter-${obs_filter_eff}_${event_type}_eastern_africa_2016-01-01_None_${eval_truth}_precip')",
        "refresh": 2,
        "regex": "",
        "type": "query",
        "includeAll": false,
